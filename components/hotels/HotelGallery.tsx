...
export function HotelGallery({ images, hotelName }: HotelGalleryProps): ReactNode {
  ...
  return (
    <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_7rem]">
      <div className="relative aspect-[16/10] overflow-hidden rounded-glass">
        <Image
          src={activeImage}
          alt={t("galleryImage", { hotel: hotelName })}
          fill
          priority
      ...
      <div className="flex lg:flex-col justify-start gap-3">
