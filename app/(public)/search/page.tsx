...
export async function generateMetadata(): Promise<Metadata> { const t = await getTranslations("discovery.headers.search"); return { title: `${t("title")} | Turath`, description: t("description") }; }
