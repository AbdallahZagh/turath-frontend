...
export async function generateMetadata(): Promise<Metadata> { const t = await getTranslations("discovery.headers.explore"); return { title: t("title"), description: t("description") }; }
